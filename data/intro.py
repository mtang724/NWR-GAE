...
G.add_edges_from([(0, 1), (0, 2), (1, 3), (2, 3), (0, 4), (0, 5), (0, 6), (2, 4), (2, 5), (2, 6), (4, 5), (5, 6),
                  (1, 7), (1, 8), (1, 9), (3, 7), (3, 8), (3, 9), (7, 8), (8, 9), (4, 6), (7, 9)])
nx.draw(G)
plt.show()
#
...
attrs = {0: {"role": 0, "attr": [1, 1, 1, 1, 1, 4]}, 1: {"role": 1, "attr": [100, 100, 100, 100, 100, 4]},
         2: {"role": 0, "attr": [1, 1, 1, 1, 1, 4]}, 3: {"role": 1, "attr": [100, 100, 100, 100, 100, 4]},
         4: {"role": 2, "attr": [1, 1, 1, 1, 1, 3]}, 5: {"role": 2, "attr": [1, 1, 1, 1, 1, 3]},
         6: {"role": 2, "attr": [1, 1, 1, 1, 1, 3]}, 7: {"role": 3, "attr": [100, 100, 100, 100, 100, 3]},
         8: {"role": 3, "attr": [100, 100, 100, 100, 100, 3]}, 9: {"role": 3, "attr": [100, 100, 100, 100, 100, 3]}
         }
